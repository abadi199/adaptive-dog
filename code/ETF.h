...
public:
	...
	void tensor(imatrix& image);
	void SmoothTensor(imatrix& image, double sigma);
	void Smooth(int half_w, int M);
	void Smooth2(int half_w, int M);
	void Smooth3(int half_w, int M);
	void SmoothFull(int half_w, int M);
	void orient180(); 
