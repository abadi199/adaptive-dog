...
\begin{figure}[H]
	...
	\subfigure[Input image]{
		...
		\includegraphics[width=2.7in]{pictures/coffeebeans/image.eps}
	}
	\subfigure[Polarity-based image segment; white indicates isotropic area, black indicates anisotropic area, and gray indicates area with low gradient magnitude]{
		...
		\includegraphics[width=2.7in]{pictures/coffeebeans/polarity.eps}
	}
...
\begin{figure}[H]
	...
	\subfigure[Input Image]{
		...
		\includegraphics[width=2.7in]{pictures/shoes/image.eps}
	}
	\subfigure[Adaptive-DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\label{fig:Adaptive_sample}
		\fbox{\includegraphics[width=2.7in]{pictures/shoes/adaptive.eps}}
	}
...
\begin{figure}[H]
	\centering
	\subfigure[Input Image]{
		\includegraphics[width=2.5in]{pictures/beach_rock_boat/image.eps}
	}	
	\subfigure[Polarity Segment]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.5in]{pictures/beach_rock_boat/polarity.eps}}
	}
	\subfigure[Adaptive-DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=3in]{pictures/beach_rock_boat/adaptive.eps}}
	}
...
\begin{figure}[H]
	\centering
	\subfigure[Input Image]{
		\includegraphics[width=2.7in]{pictures/boat_in_sand/image.eps}
	}	
	\subfigure[DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sand/dog.eps}}
	}
	\subfigure[FDoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sand/cld.eps}}
	}
	\subfigure[Adaptive-DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sand/adaptive.eps}}
	}
...
\begin{figure}[H]
	\centering
	\subfigure[Input Image]{
		\includegraphics[width=2.5in]{pictures/sand_dollar/image.eps}
	}	
	\subfigure[DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.5in]{pictures/sand_dollar/dog.eps}}
	}
	\subfigure[FDoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.5in]{pictures/sand_dollar/cld.eps}}
	}
	\subfigure[Adaptive-DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.5in]{pictures/sand_dollar/adaptive.eps}}
	}
...
\begin{figure}[H]
	\centering
	\subfigure[Input Image]{
		\includegraphics[width=2.7in]{pictures/boat_in_sf/image.eps}
	}	
	\subfigure[DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sf/dog.eps}}
	}
	\subfigure[FDoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sf/cld.eps}}
	}
	\subfigure[Adaptive-DoG]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sf/adaptive.eps}}
	}
	\subfigure[Adaptive-DoG Thin]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sf/adaptivethin.eps}}
	}
	\subfigure[Canny's Edge Detection]{
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[width=2.7in]{pictures/boat_in_sf/canny.eps}}
	}
